...
function Drawer({onClickClose, onDeleteCard,}){
    ...
    // const {cartPanel} = React.useContext(AppContext);
        ...
        <div>
          <div className='overlay'>
            <div className='drawer d-flex flex-column'>
                ...
                </>) : <Info img={orderComplete ? "img/order-complete.svg" : "img/empty-box.svg"}
                            header={orderComplete ? "Заказ оформлен!" : "Корзина пустая"}
